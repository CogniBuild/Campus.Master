...
export const signInSuccess = createAction('[Auth/API] Sign In Success', props<{ token: string }>());
export const signInFailed = createAction('[Auth/API] Sign In Failed', props<{ httpError: HttpErrorResponse }>());
